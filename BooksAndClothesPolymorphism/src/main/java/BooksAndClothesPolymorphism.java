...
public class BooksAndClothesPolymorphism {
    private static Item[] shoppingCart = new Item[2];   // contains items in user's shopping cart
    ...
    public static void main(String[] args) {
        ...
        do {
            try {
                ...
                stdin.next();// useful for catch to jump out of loop and also conitue shopping
            }             
